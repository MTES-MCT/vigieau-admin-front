...
useHead({
  title: `Données personnelles - ${appName}`,
});
...
<template>
  ...
  <div>
    ...
    <p>
      ...
      service permet aux agents en DDT de saisir les arrêtés de cadre et de restriction relatifs à la gestion de la sécheresse. {{ appName
      }} permet d’alimenter le site VigiEau, visant à informer les usagers de l’eau sur les restrictions de l’usage de l’eau en vigueur
      localement en France.<br /><br />
    ...
    <p>
      ...
      <ul>
        <li>Gérer les comptes utilisateurs des agents en services déconcentrés (DDT, DREAL et MTECT)</li>
        <li>Envoyer des notifications par mail pour fluidifier la saisie des arrêtés sécheresse</li>
      </ul>
    </p>
    ...
    <p>
      ...
      <ul>
        ...
        <li>Nom Prénom</li>
        <li>Administration et département où exerce l’agent</li>
      </ul>
    </p>
    ...
    <p>
      <div class="fr-table">
        <table>
          ...
          <tbody>
          <tr>
            <td>Données de contact : adresse e-mail, nom, prénom, administration et département où exerce l'agent</td>
      ...
      <div class="fr-table">
        <table>
          ...
          <tr>
            ...
            <td><a href="https://scalingo.com/fr/contrat-gestion-traitements-donnees-personnelles" target="_blank" rel="external">https://scalingo.com/fr/contrat-gestion-traitements-donnees-personnelles</a>
            </td>
          </tr>
          </tbody>
        </table>
